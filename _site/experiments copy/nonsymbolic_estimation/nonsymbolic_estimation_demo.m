%% Nonsymbolic stimuli 
img_dir = '/Users/pinheirochagas/Pedro/Stanford/code/MathCognitionUCSF-Testing.github.io/experiments/nonsymbolic_estimation'
...
for i = 1:size(allcombs,1)
    ...
    filename = [img_dir, '/img/dots', '_', num2str(allcombs(i,1)), '_', num2str(i), '.png'];
...
fid = fopen([img_dir '/stimuli.js'], 'w');
fprintf(fid, '%s', str);
fclose(fid)
